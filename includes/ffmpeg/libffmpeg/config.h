...
#define FFMPEG_CONFIGURATION "--arch=arm --cpu=cortex-a8 --enable-neon --enable-thumb --enable-openssl --disable-gpl --disable-nonfree --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-encoders --disable-hwaccels --disable-muxers --disable-devices --disable-iconv --enable-protocol=async --disable-linux-perf --prefix=/Volumes/D/OpenSource/ijkplayer_build/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output --cross-prefix=arm-linux-androideabi- --enable-cross-compile --target-os=linux --enable-pic --enable-asm --enable-inline-asm --enable-optimizations --enable-debug --enable-small --extra-cflags='-O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -DNDEBUG -I/Volumes/D/OpenSource/ijkplayer_build/ijkplayer-android/android/contrib/build/openssl-armv7a/output/include -march=armv7-a -mcpu=cortex-a8 -mfpu=vfpv3-d16 -mfloat-abi=softfp -mthumb' --extra-ldflags=' -L/Volumes/D/OpenSource/ijkplayer_build/ijkplayer-android/android/contrib/build/openssl-armv7a/output/lib -lssl -lcrypto -Wl,--fix-cortex-a8'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Volumes/D/OpenSource/ijkplayer_build/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
#define AVCONV_DATADIR "/Volumes/D/OpenSource/ijkplayer_build/ijkplayer-android/android/contrib/build/ffmpeg-armv7a/output/share/ffmpeg"
